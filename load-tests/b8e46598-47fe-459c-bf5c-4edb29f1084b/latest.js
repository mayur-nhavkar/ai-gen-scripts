...
export default function () {
    ...
    const createCartBody = JSON.stringify({ /* example JSON body for CartCreate */ });
    ...
    params.tags.endpoint = '/api/v1/products/sku123';
    res = http.get(`${baseUrl}/api/v1/products/sku123`, params);
    check(res, { 'status is 2xx': (r) => r.status >= 200 && r.status < 300 });
    sleep(1);
}